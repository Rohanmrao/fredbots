...
class AtomEnv(gym.Env):
    def __init__(self):
        ...
        rospy.init_node('atom_4_move', anonymous=True)
        self.velocity_publisher = rospy.Publisher('/atom_4/cmd_vel', Twist, queue_size=10)
        self.pose_subscriber = rospy.Subscriber('/atom_4/odom', Odometry, self.update_pose)
        self.lasersub = rospy.Subscriber('/scan', LaserScan, scan_callback)
    ...
    def set_robot_coordinates_to_init(self):
        ...
        print("\n RESET")
        self.state_msg.model_name = 'atom_4'
