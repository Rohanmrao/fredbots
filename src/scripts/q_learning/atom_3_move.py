...
class AtomEnv(gym.Env):
    def __init__(self):
        ...
        rospy.init_node('atom_3_move', anonymous=True)
        self.velocity_publisher = rospy.Publisher('/atom_3/cmd_vel', Twist, queue_size=10)
        self.pose_subscriber = rospy.Subscriber('/atom_3/odom', Odometry, self.update_pose)
    ...
    def set_robot_coordinates_to_init(self):
        ...
        print("\n RESET")
        self.state_msg.model_name = 'atom_3'
